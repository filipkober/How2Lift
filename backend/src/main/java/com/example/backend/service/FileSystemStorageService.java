...
public class FileSystemStorageService implements StorageService {
    ...
    public FileSystemStorageService(StorageProperties properties) {
        ...
        if(properties.getLocation().trim().length() == 0) {
            throw new StorageException("File upload location is not set");
        }
    ...
    public void init() {
        try {
            ...
            String fullDirectoryPath = rootLocation.toAbsolutePath().toString();
            System.out.println("Directory created: " + fullDirectoryPath);
        }
        catch (IOException e) {
